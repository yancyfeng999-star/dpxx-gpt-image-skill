...
| 需要复用模板批量出图（变量化主题/价格/品类） | **B + argument** |
...
Color-accurate, advertising-grade. No watermarks. No price tags.
```
  ...
  "layout": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "text_overlay": "{argument name=\"stat\" default=\"30% OFF\"}",
        "subline": "{argument name=\"stat_sub\" default=\"All luggage this week\"}"
      },
      {
